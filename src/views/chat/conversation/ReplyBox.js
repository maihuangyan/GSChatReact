    ...
    return (
        <Box sx={{ display: isReply ? "flex" : "none", justifyContent: "start", alignItems: "center", p: "0 0 0 5px", background: "#101010", mb: "5px" }}>
            ...
            <Typography component="div" sx={{
                ...
                <Typography component="p" color="#b5b5b5">{replyMessage?.type == 0 ? replyMessage.message : (replyMessage?.type == 1 ? "image" : (replyMessage?.type == 3 ? replyMessage.forward_message.message : ""))}</Typography>
            </Typography>
        </Box>
    )
}
